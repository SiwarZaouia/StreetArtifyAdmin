...
const CardEventApproveTest = (props) => {
...
const handleCityChange = (e) => {
  ...
  const [approving_art] = useMutation(approve_art);
  const handle_approve_art = async () => {
    try {
      const { data } = await approving_art({
        variables: {
          update_values: {
            title,
            country,
...
export default CardEventApproveTest;